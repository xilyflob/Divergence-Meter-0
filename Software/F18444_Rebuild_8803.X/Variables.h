...
//Fixed clock values
#define ClockAddress 0b0110010 //address for accessing the clock, 8803
...
#define FlagReg 0x0E //location of the flag register in the clock, 8803
#define CtrlReg 0x0F //location of the control register in the clock, 8803
